 ...
 * Unique MAC Address for Arduino
 ...
 Modified by www.xmas4all.co.uk to use ws2811 leds and addes a option to globally change the transition time.
...
#define dlay 200                                  // Set the speed of the colour transition
...
byte mac[] = {
  0x90, 0xA2, 0xda, 0x00, 0x8d, 0x08 }; // Must be unique on local network
